...
iconv.getCodec = function getCodec (encoding) {
  if (!iconv.encodings) {
    ...
    iconv.encodings = Object.assign(Object.create(null), raw)
  }
...
iconv.enableStreamingAPI = function enableStreamingAPI (streamModule) {
  ...
  iconv.encodeStream = function encodeStream (encoding, options) {
    return new iconv.IconvLiteEncoderStream(iconv.getEncoder(encoding, options), options, iconv)
  }

  iconv.decodeStream = function decodeStream (encoding, options) {
    return new iconv.IconvLiteDecoderStream(iconv.getDecoder(encoding, options), options, iconv)
  }
...
iconv.setBackend = function (backend) {
